...
MobileAdTargetingInfo targetingInfo = MobileAdTargetingInfo(
  keywords: <String>['eating', 'food','chicken','momos','shopping','cloths'],
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        obscureText: true,autovalidate: true,
                        decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: "Password",
              ...
              RaisedButton(
                onPressed: ()  {
                  myBanner==null?null:myBanner.dispose();

                  userRepo.signIn(_email.text, _password.text).then((FirebaseUser user) async {
