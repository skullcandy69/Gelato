                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) => _buildListItem(context,
                          snapshot.data.documents[index], index, product));
                },
              ),
            ));
      },
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            // InkWell(
                            //   onTap: () { Provider.of<ProductModel>(context,
                            //             listen: false)
                            //         .removeItem(index);},
                            //   child: Icon(
                            //     Icons.remove,
                            ...
                            // ),
                            product.getQuanity(
                                        document["name"], document["vendor"]) >
                                    0
                                ? InkWell(
                                    onTap: () {
                                      product.removeItem(Productmod(
                                        document["name"],
                                        document["vendor"],
                                        document["price"],
                                        document["url"],
